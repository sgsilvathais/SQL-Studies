...
--O gestor de marketing pediu a lista das funcionárias que trabalham no departamento de filmes OU no departamento lar. Ele necessita enviar um email para as colaboradoras desses dois setores.
...
-- Traga os funcionários do sexo masculino ou os funcionários que trabalhem no departamento de Jardim.
